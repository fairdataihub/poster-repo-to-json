...
from poster_to_json.field_normalize import (  # noqa: E402
    ...
    clean_conference_junk, drop_junk_sections, drop_junk_captions, conform_to_schema,
)

# (name, fn) — fn(record) -> changed:bool.
NORMALIZERS = [
    ("multidate_collapse", collapse_multidate_ranges),
    ...
    ("descriptions", drop_junk_descriptions),
    ("lumped_split", normalize_lumped_creators),
    ("creators", normalize_creators),
    ("affil_in_name", normalize_affiliation_in_name),
    ("creators_letterless", drop_letterless_creator_fields),
    ("affil_names", normalize_affiliation_names),
    ...
    ("presented_date", ensure_presented_date),
    ("conform_schema", conform_to_schema),
]
